                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                <h3>Refund of Security Notice</h3>
                                <div class="mb-15">
                                    <p>It is a security deposit which is refundable at the time when the tenant’s contract ends or the termination of the lease.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
                                            ...
                                            <div class="col-sm-6">
                                                <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor ttm-textcolor-darkgrey">
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Gift Deed Drafting</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Lease Agreement Drafting </div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Property Verification</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Marriage Registration</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Succession Certificate</div>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="col-sm-6">
                                                <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor ttm-textcolor-darkgrey">
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Marriage Counselling</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Para Legal</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Divorce Notice</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Property Registration</div>
                                                    </li>
                                                    <li><i class="fa fa-arrow-circle-right"></i>
                                                        <div class="ttm-list-li-content">Court Marriage</div>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
