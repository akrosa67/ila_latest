                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                <h3>Will Drafting</h3>
                                <div class="mb-15">
                                    <p>A will drafting is a legal document expresses their wishes as how their property is to be distributed.  If the person die without writing a will those wishes may not be carried out.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
