                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                ...
                                <div class="mb-15">
                                    <p>It is a legal documents executed by one or more persons giving an authority to one or more persons to act on his behalf.  The person giving authority is called attorney.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
