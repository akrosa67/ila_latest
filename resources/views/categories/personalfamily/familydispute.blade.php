                                     ...
                                     <div class="row mt-15 mb-30">
                                            <div class="col-sm-6">
                                                <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor ttm-textcolor-darkgrey">
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Sibling rivalry </div></li>
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Husband wife miscommunication </div></li>                                                    
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">In-laws rivalry </div></li>                                                    
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Husband wife rivalry </div></li>                                                    
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Parents children rivalry </div></li>
