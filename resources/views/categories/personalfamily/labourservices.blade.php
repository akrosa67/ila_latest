                                        ...
                                        <div class="row mt-15 mb-30">
                                            <div class="col-sm-6">
                                                <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor ttm-textcolor-darkgrey">
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Administrative rulings </div></li>
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Legal rights of the employees</div></li>
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Certification of unions</div></li>
                                                    <li><i class="fa fa-arrow-circle-right"></i><div class="ttm-list-li-content">Labour and management relationship</div></li>
