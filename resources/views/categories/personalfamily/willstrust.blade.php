                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                ...
                                <div class="mb-15">
                                    <h6>Wills</h6>
                                    <p>A will is a legal document that spells out your wishes regarding the care of the children as well as the distribution of the assets after the death of the parents.</p>
                                    <h6>Trusts</h6>
                                    <p>It is a legal relationship that the owner of property who gives it to third party or entity who must keep and use it solely for a third party’s benefit.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
