                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                ...
                                <div class="mb-15">
                                    <p>The terms land lord refers to a person who owns its property and allows another person to use it for a fee.</p>
                                    <p>The person who is using the property is called tenant.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
