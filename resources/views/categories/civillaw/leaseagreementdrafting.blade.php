                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                <h3>Lease Agreement Drafting</h3>
                                <div class="mb-15">
                                    <p>It is created between lessor and lessee which provides rights to the lessee to use such property for a period of time owned by the lessor.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
