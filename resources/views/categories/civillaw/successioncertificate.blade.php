                    ...
                    <div class="col-lg-8 content-area">
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                ...
                                <div class="mb-15">
                                    <p>It is a certificate under the legal Act,  It is a document that gives authority to the person who obtains it to represent the deceased for the purpose of collecting debts and securities due to him or payable on his name.</p>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <!-- ttm-fid -->
